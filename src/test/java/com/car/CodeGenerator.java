...
public class CodeGenerator {
    ...
    public void run() {
        ...
        gc.setOutputDir("D:\\java_project\\car" + "\\src\\main\\java");
        // 生成注释时的作者
        gc.setAuthor("djh");
        //生成后是否打开资源管理器
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:postgresql://8.130.64.69:5432/car");
        dsc.setDriverName("org.postgresql.Driver");
        dsc.setUsername("caradmin");
        dsc.setPassword("2z2j4jTLsBAL");
        ...
        strategy.setInclude("reservations");
